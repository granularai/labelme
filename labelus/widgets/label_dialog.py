...
class LabelDialog(QtWidgets.QDialog):
    ...
    def __init__(self, text="Enter object label", parent=None, labels=None,
        ...
        self.edit.setValidator(labelus.utils.labelValidator())
        ...
        bb.button(bb.Ok).setIcon(labelus.utils.newIcon('done'))
        bb.button(bb.Cancel).setIcon(labelus.utils.newIcon('undo'))
